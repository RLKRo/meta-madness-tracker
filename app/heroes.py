...
def extract_heroes_from_tracker_events(archive: mpyq.MPQArchive, protocol, filter_names=True):
    """
...
def extract_heroes_from_replay(replay):
    ...
    """
    unsuccessful_extraction_message = "Could not extract heroes from replay. " \
